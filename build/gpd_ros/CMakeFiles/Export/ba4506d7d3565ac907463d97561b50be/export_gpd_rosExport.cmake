...
foreach(_cmake_expected_target IN ITEMS gpd_ros::grasp_messages gpd_ros::grasp_plotter gpd_ros::grasp_detection_server gpd_ros::grasp_pose_server)
...
# Create imported target gpd_ros::grasp_detection_server
add_executable(gpd_ros::grasp_detection_server IMPORTED)
...
# Create imported target gpd_ros::grasp_pose_server
add_executable(gpd_ros::grasp_pose_server IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/export_gpd_rosExport-*.cmake")
...
foreach(_target "gpd_ros::gpd_ros__rosidl_typesupport_cpp" )
