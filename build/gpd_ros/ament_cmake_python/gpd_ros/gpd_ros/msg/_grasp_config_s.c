...
bool gpd_ros__msg__grasp_config__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gpd_ros.msg._grasp_config.GraspConfig", full_classname_dest, 37) == 0);
  }
  gpd_ros__msg__GraspConfig * ros_message = _ros_message;
  {  // position
...
PyObject * gpd_ros__msg__grasp_config__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gpd_ros.msg._grasp_config");
