...
class GraspConfigList(metaclass=Metaclass_GraspConfigList):
    ...
    _fields_and_field_types = {
        ...
        'grasps': 'sequence<gpd_ros/GraspConfig>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['gpd_ros', 'msg'], 'GraspConfig')),  # noqa: E501
    )
