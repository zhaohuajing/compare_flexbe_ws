...
static const _CloudSamples_type_support_symbol_names_t _CloudSamples_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros, msg, CloudSamples)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpd_ros, msg, CloudSamples)),
  }
};
...
{
  return &::gpd_ros::msg::rosidl_typesupport_cpp::CloudSamples_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpd_ros, msg, CloudSamples)() {
  return get_message_type_support_handle<gpd_ros::msg::CloudSamples>();
}
