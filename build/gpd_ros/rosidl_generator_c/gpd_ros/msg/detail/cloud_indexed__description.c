...
static char gpd_ros__msg__CloudIndexed__FIELD_NAME__cloud_sources[] = "cloud_sources";
static char gpd_ros__msg__CloudIndexed__FIELD_NAME__indices[] = "indices";

static rosidl_runtime_c__type_description__Field gpd_ros__msg__CloudIndexed__FIELDS[] = {
  {
    {gpd_ros__msg__CloudIndexed__FIELD_NAME__cloud_sources, 13, 13},
    {
  ...
  {
    {gpd_ros__msg__CloudIndexed__FIELD_NAME__indices, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription gpd_ros__msg__CloudIndexed__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {gpd_ros__msg__CloudIndexed__FIELDS, 2, 2},
    },
    {gpd_ros__msg__CloudIndexed__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
...
gpd_ros__msg__CloudIndexed__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *gpd_ros__msg__CloudIndexed__get_individual_type_description_source(NULL),
