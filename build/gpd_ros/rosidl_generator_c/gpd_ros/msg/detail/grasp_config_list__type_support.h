...
#ifndef GPD_ROS__MSG__DETAIL__GRASP_CONFIG_LIST__TYPE_SUPPORT_H_
#define GPD_ROS__MSG__DETAIL__GRASP_CONFIG_LIST__TYPE_SUPPORT_H_
...
#endif  // GPD_ROS__MSG__DETAIL__GRASP_CONFIG_LIST__TYPE_SUPPORT_H_
