...
#include "gpd_ros/msg/detail/cloud_indexed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gpd_ros::msg::CloudIndexed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gpd_ros::msg::CloudIndexed & ros_message)
{
  // Member: cloud_sources
  ...
  // Member: indices
  {
    ...
    ros_message.indices.resize(size);
    for (size_t i = 0; i < size; i++) {
      std_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.indices[i]);
    }
  }
  ...
  // Member: indices
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.indices[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros::msg::CloudIndexed;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gpd_ros::msg::CloudIndexed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gpd_ros::msg::CloudIndexed *>(
    untyped_ros_message);
...
{
  return &gpd_ros::msg::typesupport_fastrtps_cpp::_CloudIndexed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros, msg, CloudIndexed)() {
  return &gpd_ros::msg::typesupport_fastrtps_cpp::_CloudIndexed__handle;
}
