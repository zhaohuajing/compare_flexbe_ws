...
#include "gpd_ros/msg/detail/samples_msg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros::msg::SamplesMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gpd_ros::msg::SamplesMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gpd_ros::msg::SamplesMsg *>(
    untyped_ros_message);
...
{
  return &gpd_ros::msg::typesupport_fastrtps_cpp::_SamplesMsg__handle;
}
