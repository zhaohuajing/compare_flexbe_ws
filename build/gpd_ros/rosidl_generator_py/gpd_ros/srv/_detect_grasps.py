...
class DetectGrasps_Request(metaclass=Metaclass_DetectGrasps_Request):
    ...
    _fields_and_field_types = {
        'cloud_indexed': 'gpd_ros/CloudIndexed',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['gpd_ros', 'msg'], 'CloudIndexed'),  # noqa: E501
    )
...
class DetectGrasps_Event(metaclass=Metaclass_DetectGrasps_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<gpd_ros/DetectGrasps_Request, 1>',
        'response': 'sequence<gpd_ros/DetectGrasps_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gpd_ros', 'srv'], 'DetectGrasps_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gpd_ros', 'srv'], 'DetectGrasps_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from gpd_ros.srv import DetectGrasps_Request
    ...
    def response(self, value):
        if self._check_fields:
            from gpd_ros.srv import DetectGrasps_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_DetectGrasps(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from gpd_ros.srv import _detect_grasps
...
class DetectGrasps(metaclass=Metaclass_DetectGrasps):
    from gpd_ros.srv._detect_grasps import DetectGrasps_Request as Request
    from gpd_ros.srv._detect_grasps import DetectGrasps_Response as Response
    from gpd_ros.srv._detect_grasps import DetectGrasps_Event as Event
