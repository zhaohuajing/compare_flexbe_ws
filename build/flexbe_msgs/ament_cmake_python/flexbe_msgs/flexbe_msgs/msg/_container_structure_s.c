...
bool flexbe_msgs__msg__container_structure__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.msg._container_structure.ContainerStructure", full_classname_dest, 55) == 0);
  }
  flexbe_msgs__msg__ContainerStructure * ros_message = _ros_message;
  {  // behavior_id
  ...
  {  // containers
    PyObject * field = PyObject_GetAttrString(_pymsg, "containers");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'containers'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    flexbe_msgs__msg__Container * dest = ros_message->containers.data;
...
{
  /* NOTE(esteve): Call constructor of ContainerStructure */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.msg._container_structure");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ContainerStructure");
  ...
  {  // containers
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->containers.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "containers", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
