...
bool flexbe_msgs__msg__userdata_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.msg._userdata_info.UserdataInfo", full_classname_dest, 43) == 0);
  }
  flexbe_msgs__msg__UserdataInfo * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of UserdataInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.msg._userdata_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UserdataInfo");
