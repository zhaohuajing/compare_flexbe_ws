...
class MoveToPose_Event(metaclass=Metaclass_MoveToPose_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<compare_flexbe_utilities/MoveToPose_Request, 1>',
        'response': 'sequence<compare_flexbe_utilities/MoveToPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['compare_flexbe_utilities', 'srv'], 'MoveToPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['compare_flexbe_utilities', 'srv'], 'MoveToPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from compare_flexbe_utilities.srv import MoveToPose_Request
    ...
    def response(self, value):
        if self._check_fields:
            from compare_flexbe_utilities.srv import MoveToPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    ...
    from compare_flexbe_utilities.srv._move_to_pose import MoveToPose_Event as Event
