...
class Metaclass_CartesianMoveToPose_Event(type):
    """Metaclass of message 'CartesianMoveToPose_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__cartesian_move_to_pose__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__cartesian_move_to_pose__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__cartesian_move_to_pose__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__cartesian_move_to_pose__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__cartesian_move_to_pose__event
...
class CartesianMoveToPose_Event(metaclass=Metaclass_CartesianMoveToPose_Event):
    """Message class 'CartesianMoveToPose_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<compare_flexbe_utilities/CartesianMoveToPose_Request, 1>',
        'response': 'sequence<compare_flexbe_utilities/CartesianMoveToPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['compare_flexbe_utilities', 'srv'], 'CartesianMoveToPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['compare_flexbe_utilities', 'srv'], 'CartesianMoveToPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from compare_flexbe_utilities.srv import CartesianMoveToPose_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, CartesianMoveToPose_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'CartesianMoveToPose_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from compare_flexbe_utilities.srv import CartesianMoveToPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, CartesianMoveToPose_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'CartesianMoveToPose_Response'"
...
class Metaclass_CartesianMoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _cartesian_move_to_pose.Metaclass_CartesianMoveToPose_Event._TYPE_SUPPORT is None:
                _cartesian_move_to_pose.Metaclass_CartesianMoveToPose_Event.__import_type_support__()
...
class CartesianMoveToPose(metaclass=Metaclass_CartesianMoveToPose):
    ...
    from compare_flexbe_utilities.srv._cartesian_move_to_pose import CartesianMoveToPose_Event as Event
