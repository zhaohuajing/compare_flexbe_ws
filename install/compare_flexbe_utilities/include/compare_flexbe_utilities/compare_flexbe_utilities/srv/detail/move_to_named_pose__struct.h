...
enum
{
  compare_flexbe_utilities__srv__MoveToNamedPose_Event__request__MAX_SIZE = 1
};
// response
enum
{
  compare_flexbe_utilities__srv__MoveToNamedPose_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MoveToNamedPose in the package compare_flexbe_utilities.
typedef struct compare_flexbe_utilities__srv__MoveToNamedPose_Event
{
  service_msgs__msg__ServiceEventInfo info;
  compare_flexbe_utilities__srv__MoveToNamedPose_Request__Sequence request;
  compare_flexbe_utilities__srv__MoveToNamedPose_Response__Sequence response;
} compare_flexbe_utilities__srv__MoveToNamedPose_Event;

// Struct for a sequence of compare_flexbe_utilities__srv__MoveToNamedPose_Event.
typedef struct compare_flexbe_utilities__srv__MoveToNamedPose_Event__Sequence
{
