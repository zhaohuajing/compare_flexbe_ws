...
inline void to_flow_style_yaml(
  const FilterByIndices_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const FilterByIndices_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use compare_flexbe_utilities::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const compare_flexbe_utilities::srv::FilterByIndices_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  compare_flexbe_utilities::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use compare_flexbe_utilities::srv::to_yaml() instead")]]
inline std::string to_yaml(const compare_flexbe_utilities::srv::FilterByIndices_Event & msg)
{
  return compare_flexbe_utilities::srv::to_yaml(msg);
}

template<>
inline const char * data_type<compare_flexbe_utilities::srv::FilterByIndices_Event>()
{
  return "compare_flexbe_utilities::srv::FilterByIndices_Event";
}

template<>
inline const char * name<compare_flexbe_utilities::srv::FilterByIndices_Event>()
{
  return "compare_flexbe_utilities/srv/FilterByIndices_Event";
}

template<>
struct has_fixed_size<compare_flexbe_utilities::srv::FilterByIndices_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<compare_flexbe_utilities::srv::FilterByIndices_Event>
  : std::integral_constant<bool, has_bounded_size<compare_flexbe_utilities::srv::FilterByIndices_Request>::value && has_bounded_size<compare_flexbe_utilities::srv::FilterByIndices_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<compare_flexbe_utilities::srv::FilterByIndices_Event>
  : std::true_type {};
