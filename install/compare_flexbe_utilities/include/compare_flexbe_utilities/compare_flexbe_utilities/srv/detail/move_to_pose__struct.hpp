...
#ifndef _WIN32
# define DEPRECATED__compare_flexbe_utilities__srv__MoveToPose_Event __attribute__((deprecated))
#else
# define DEPRECATED__compare_flexbe_utilities__srv__MoveToPose_Event __declspec(deprecated)
#endif
...
struct MoveToPose_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<compare_flexbe_utilities::srv::MoveToPose_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<compare_flexbe_utilities::srv::MoveToPose_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<compare_flexbe_utilities::srv::MoveToPose_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<compare_flexbe_utilities::srv::MoveToPose_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<compare_flexbe_utilities::srv::MoveToPose_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<compare_flexbe_utilities::srv::MoveToPose_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<compare_flexbe_utilities::srv::MoveToPose_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<compare_flexbe_utilities::srv::MoveToPose_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__compare_flexbe_utilities__srv__MoveToPose_Event
    std::shared_ptr<compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__compare_flexbe_utilities__srv__MoveToPose_Event
    std::shared_ptr<compare_flexbe_utilities::srv::MoveToPose_Event_<ContainerAllocator> const>
...
using MoveToPose_Event =
  compare_flexbe_utilities::srv::MoveToPose_Event_<std::allocator<void>>;
...
struct MoveToPose
{
  ...
  using Event = compare_flexbe_utilities::srv::MoveToPose_Event;
};
