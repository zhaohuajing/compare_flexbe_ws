...
class Metaclass_VoxelGridFilter_Event(type):
    """Metaclass of message 'VoxelGridFilter_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__voxel_grid_filter__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__voxel_grid_filter__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__voxel_grid_filter__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__voxel_grid_filter__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__voxel_grid_filter__event
...
class VoxelGridFilter_Event(metaclass=Metaclass_VoxelGridFilter_Event):
    """Message class 'VoxelGridFilter_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<compare_flexbe_utilities/VoxelGridFilter_Request, 1>',
        'response': 'sequence<compare_flexbe_utilities/VoxelGridFilter_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['compare_flexbe_utilities', 'srv'], 'VoxelGridFilter_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['compare_flexbe_utilities', 'srv'], 'VoxelGridFilter_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from compare_flexbe_utilities.srv import VoxelGridFilter_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, VoxelGridFilter_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'VoxelGridFilter_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from compare_flexbe_utilities.srv import VoxelGridFilter_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, VoxelGridFilter_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'VoxelGridFilter_Response'"
...
class Metaclass_VoxelGridFilter(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _voxel_grid_filter.Metaclass_VoxelGridFilter_Event._TYPE_SUPPORT is None:
                _voxel_grid_filter.Metaclass_VoxelGridFilter_Event.__import_type_support__()
...
class VoxelGridFilter(metaclass=Metaclass_VoxelGridFilter):
    ...
    from compare_flexbe_utilities.srv._voxel_grid_filter import VoxelGridFilter_Event as Event
