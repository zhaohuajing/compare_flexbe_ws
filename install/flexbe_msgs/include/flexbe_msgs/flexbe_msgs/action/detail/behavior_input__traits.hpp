...
inline void to_flow_style_yaml(
  const BehaviorInput_SendGoal_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const BehaviorInput_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use flexbe_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const flexbe_msgs::action::BehaviorInput_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  flexbe_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use flexbe_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const flexbe_msgs::action::BehaviorInput_SendGoal_Event & msg)
{
  return flexbe_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<flexbe_msgs::action::BehaviorInput_SendGoal_Event>()
{
  return "flexbe_msgs::action::BehaviorInput_SendGoal_Event";
}

template<>
inline const char * name<flexbe_msgs::action::BehaviorInput_SendGoal_Event>()
{
  return "flexbe_msgs/action/BehaviorInput_SendGoal_Event";
}

template<>
struct has_fixed_size<flexbe_msgs::action::BehaviorInput_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<flexbe_msgs::action::BehaviorInput_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<flexbe_msgs::action::BehaviorInput_SendGoal_Request>::value && has_bounded_size<flexbe_msgs::action::BehaviorInput_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<flexbe_msgs::action::BehaviorInput_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const BehaviorInput_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const BehaviorInput_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use flexbe_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const flexbe_msgs::action::BehaviorInput_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  flexbe_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use flexbe_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const flexbe_msgs::action::BehaviorInput_GetResult_Event & msg)
{
  return flexbe_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<flexbe_msgs::action::BehaviorInput_GetResult_Event>()
{
  return "flexbe_msgs::action::BehaviorInput_GetResult_Event";
}

template<>
inline const char * name<flexbe_msgs::action::BehaviorInput_GetResult_Event>()
{
  return "flexbe_msgs/action/BehaviorInput_GetResult_Event";
}

template<>
struct has_fixed_size<flexbe_msgs::action::BehaviorInput_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<flexbe_msgs::action::BehaviorInput_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<flexbe_msgs::action::BehaviorInput_GetResult_Request>::value && has_bounded_size<flexbe_msgs::action::BehaviorInput_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<flexbe_msgs::action::BehaviorInput_GetResult_Event>
  : std::true_type {};
