...
void flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  flexbe_msgs__action__BehaviorExecution_SendGoal_Event__init(message_memory);
}

void flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_fini_function(void * message_memory)
{
  flexbe_msgs__action__BehaviorExecution_SendGoal_Event__fini(message_memory);
}

size_t flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__size_function__BehaviorExecution_SendGoal_Event__request(
  const void * untyped_member)
{
  const flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence * member =
    (const flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_SendGoal_Event__request(
  const void * untyped_member, size_t index)
{
  const flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence * member =
    (const flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence *)(untyped_member);
...
void * flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_SendGoal_Event__request(
  void * untyped_member, size_t index)
{
  flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence * member =
    (flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__fetch_function__BehaviorExecution_SendGoal_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const flexbe_msgs__action__BehaviorExecution_SendGoal_Request * item =
    ((const flexbe_msgs__action__BehaviorExecution_SendGoal_Request *)
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_SendGoal_Event__request(untyped_member, index));
  flexbe_msgs__action__BehaviorExecution_SendGoal_Request * value =
    (flexbe_msgs__action__BehaviorExecution_SendGoal_Request *)(untyped_value);
  *value = *item;
}

void flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__assign_function__BehaviorExecution_SendGoal_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  flexbe_msgs__action__BehaviorExecution_SendGoal_Request * item =
    ((flexbe_msgs__action__BehaviorExecution_SendGoal_Request *)
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_SendGoal_Event__request(untyped_member, index));
  const flexbe_msgs__action__BehaviorExecution_SendGoal_Request * value =
    (const flexbe_msgs__action__BehaviorExecution_SendGoal_Request *)(untyped_value);
  *item = *value;
}

bool flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__resize_function__BehaviorExecution_SendGoal_Event__request(
  void * untyped_member, size_t size)
{
  flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence * member =
    (flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence *)(untyped_member);
  flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence__fini(member);
  return flexbe_msgs__action__BehaviorExecution_SendGoal_Request__Sequence__init(member, size);
}

size_t flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__size_function__BehaviorExecution_SendGoal_Event__response(
  const void * untyped_member)
{
  const flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence * member =
    (const flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_SendGoal_Event__response(
  const void * untyped_member, size_t index)
{
  const flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence * member =
    (const flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence *)(untyped_member);
...
void * flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_SendGoal_Event__response(
  void * untyped_member, size_t index)
{
  flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence * member =
    (flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__fetch_function__BehaviorExecution_SendGoal_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const flexbe_msgs__action__BehaviorExecution_SendGoal_Response * item =
    ((const flexbe_msgs__action__BehaviorExecution_SendGoal_Response *)
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_SendGoal_Event__response(untyped_member, index));
  flexbe_msgs__action__BehaviorExecution_SendGoal_Response * value =
    (flexbe_msgs__action__BehaviorExecution_SendGoal_Response *)(untyped_value);
  *value = *item;
}

void flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__assign_function__BehaviorExecution_SendGoal_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  flexbe_msgs__action__BehaviorExecution_SendGoal_Response * item =
    ((flexbe_msgs__action__BehaviorExecution_SendGoal_Response *)
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_SendGoal_Event__response(untyped_member, index));
  const flexbe_msgs__action__BehaviorExecution_SendGoal_Response * value =
    (const flexbe_msgs__action__BehaviorExecution_SendGoal_Response *)(untyped_value);
  *item = *value;
}

bool flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__resize_function__BehaviorExecution_SendGoal_Event__response(
  void * untyped_member, size_t size)
{
  flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence * member =
    (flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence *)(untyped_member);
  flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence__fini(member);
  return flexbe_msgs__action__BehaviorExecution_SendGoal_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(flexbe_msgs__action__BehaviorExecution_SendGoal_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(flexbe_msgs__action__BehaviorExecution_SendGoal_Event, request),  // bytes offset in struct
    NULL,  // default value
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__size_function__BehaviorExecution_SendGoal_Event__request,  // size() function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_SendGoal_Event__request,  // get_const(index) function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_SendGoal_Event__request,  // get(index) function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__fetch_function__BehaviorExecution_SendGoal_Event__request,  // fetch(index, &value) function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__assign_function__BehaviorExecution_SendGoal_Event__request,  // assign(index, value) function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__resize_function__BehaviorExecution_SendGoal_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(flexbe_msgs__action__BehaviorExecution_SendGoal_Event, response),  // bytes offset in struct
    NULL,  // default value
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__size_function__BehaviorExecution_SendGoal_Event__response,  // size() function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_SendGoal_Event__response,  // get_const(index) function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_SendGoal_Event__response,  // get(index) function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__fetch_function__BehaviorExecution_SendGoal_Event__response,  // fetch(index, &value) function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__assign_function__BehaviorExecution_SendGoal_Event__response,  // assign(index, value) function pointer
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__resize_function__BehaviorExecution_SendGoal_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_members = {
  "flexbe_msgs__action",  // message namespace
  "BehaviorExecution_SendGoal_Event",  // message name
  3,  // number of fields
  sizeof(flexbe_msgs__action__BehaviorExecution_SendGoal_Event),
  false,  // has_any_key_member_
  flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_member_array,  // message members
  flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_type_support_handle = {
  0,
  &flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_flexbe_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_SendGoal_Event)() {
  flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_SendGoal_Request)();
  flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_SendGoal_Response)();
  if (!flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_type_support_handle.typesupport_identifier) {
    flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t flexbe_msgs__action__detail__behavior_execution__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_service_type_support_handle = {
  ...
  &flexbe_msgs__action__BehaviorExecution_SendGoal_Request__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Request_message_type_support_handle,
  &flexbe_msgs__action__BehaviorExecution_SendGoal_Response__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Response_message_type_support_handle,
  &flexbe_msgs__action__BehaviorExecution_SendGoal_Event__rosidl_typesupport_introspection_c__BehaviorExecution_SendGoal_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_SendGoal_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_SendGoal_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_SendGoal_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_flexbe_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_SendGoal)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_SendGoal_Event)()->data;
  }
...
void flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  flexbe_msgs__action__BehaviorExecution_GetResult_Event__init(message_memory);
}

void flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_fini_function(void * message_memory)
{
  flexbe_msgs__action__BehaviorExecution_GetResult_Event__fini(message_memory);
}

size_t flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__size_function__BehaviorExecution_GetResult_Event__request(
  const void * untyped_member)
{
  const flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence * member =
    (const flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_GetResult_Event__request(
  const void * untyped_member, size_t index)
{
  const flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence * member =
    (const flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence *)(untyped_member);
...
void * flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_GetResult_Event__request(
  void * untyped_member, size_t index)
{
  flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence * member =
    (flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__fetch_function__BehaviorExecution_GetResult_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const flexbe_msgs__action__BehaviorExecution_GetResult_Request * item =
    ((const flexbe_msgs__action__BehaviorExecution_GetResult_Request *)
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_GetResult_Event__request(untyped_member, index));
  flexbe_msgs__action__BehaviorExecution_GetResult_Request * value =
    (flexbe_msgs__action__BehaviorExecution_GetResult_Request *)(untyped_value);
  *value = *item;
}

void flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__assign_function__BehaviorExecution_GetResult_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  flexbe_msgs__action__BehaviorExecution_GetResult_Request * item =
    ((flexbe_msgs__action__BehaviorExecution_GetResult_Request *)
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_GetResult_Event__request(untyped_member, index));
  const flexbe_msgs__action__BehaviorExecution_GetResult_Request * value =
    (const flexbe_msgs__action__BehaviorExecution_GetResult_Request *)(untyped_value);
  *item = *value;
}

bool flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__resize_function__BehaviorExecution_GetResult_Event__request(
  void * untyped_member, size_t size)
{
  flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence * member =
    (flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence *)(untyped_member);
  flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence__fini(member);
  return flexbe_msgs__action__BehaviorExecution_GetResult_Request__Sequence__init(member, size);
}

size_t flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__size_function__BehaviorExecution_GetResult_Event__response(
  const void * untyped_member)
{
  const flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence * member =
    (const flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_GetResult_Event__response(
  const void * untyped_member, size_t index)
{
  const flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence * member =
    (const flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence *)(untyped_member);
...
void * flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_GetResult_Event__response(
  void * untyped_member, size_t index)
{
  flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence * member =
    (flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__fetch_function__BehaviorExecution_GetResult_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const flexbe_msgs__action__BehaviorExecution_GetResult_Response * item =
    ((const flexbe_msgs__action__BehaviorExecution_GetResult_Response *)
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_GetResult_Event__response(untyped_member, index));
  flexbe_msgs__action__BehaviorExecution_GetResult_Response * value =
    (flexbe_msgs__action__BehaviorExecution_GetResult_Response *)(untyped_value);
  *value = *item;
}

void flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__assign_function__BehaviorExecution_GetResult_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  flexbe_msgs__action__BehaviorExecution_GetResult_Response * item =
    ((flexbe_msgs__action__BehaviorExecution_GetResult_Response *)
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_GetResult_Event__response(untyped_member, index));
  const flexbe_msgs__action__BehaviorExecution_GetResult_Response * value =
    (const flexbe_msgs__action__BehaviorExecution_GetResult_Response *)(untyped_value);
  *item = *value;
}

bool flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__resize_function__BehaviorExecution_GetResult_Event__response(
  void * untyped_member, size_t size)
{
  flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence * member =
    (flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence *)(untyped_member);
  flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence__fini(member);
  return flexbe_msgs__action__BehaviorExecution_GetResult_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(flexbe_msgs__action__BehaviorExecution_GetResult_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(flexbe_msgs__action__BehaviorExecution_GetResult_Event, request),  // bytes offset in struct
    NULL,  // default value
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__size_function__BehaviorExecution_GetResult_Event__request,  // size() function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_GetResult_Event__request,  // get_const(index) function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_GetResult_Event__request,  // get(index) function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__fetch_function__BehaviorExecution_GetResult_Event__request,  // fetch(index, &value) function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__assign_function__BehaviorExecution_GetResult_Event__request,  // assign(index, value) function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__resize_function__BehaviorExecution_GetResult_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(flexbe_msgs__action__BehaviorExecution_GetResult_Event, response),  // bytes offset in struct
    NULL,  // default value
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__size_function__BehaviorExecution_GetResult_Event__response,  // size() function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__BehaviorExecution_GetResult_Event__response,  // get_const(index) function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__get_function__BehaviorExecution_GetResult_Event__response,  // get(index) function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__fetch_function__BehaviorExecution_GetResult_Event__response,  // fetch(index, &value) function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__assign_function__BehaviorExecution_GetResult_Event__response,  // assign(index, value) function pointer
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__resize_function__BehaviorExecution_GetResult_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_members = {
  "flexbe_msgs__action",  // message namespace
  "BehaviorExecution_GetResult_Event",  // message name
  3,  // number of fields
  sizeof(flexbe_msgs__action__BehaviorExecution_GetResult_Event),
  false,  // has_any_key_member_
  flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_member_array,  // message members
  flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_type_support_handle = {
  0,
  &flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_flexbe_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_GetResult_Event)() {
  flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_GetResult_Request)();
  flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_GetResult_Response)();
  if (!flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_type_support_handle.typesupport_identifier) {
    flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t flexbe_msgs__action__detail__behavior_execution__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_service_type_support_handle = {
  ...
  get_service_typesupport_handle_function,
  &flexbe_msgs__action__BehaviorExecution_GetResult_Request__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Request_message_type_support_handle,
  &flexbe_msgs__action__BehaviorExecution_GetResult_Response__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Response_message_type_support_handle,
  &flexbe_msgs__action__BehaviorExecution_GetResult_Event__rosidl_typesupport_introspection_c__BehaviorExecution_GetResult_Event_message_type_support_handle,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    flexbe_msgs,
    action,
...
// Forward declaration of message type support functions for service members
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_GetResult_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_GetResult_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_GetResult_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_flexbe_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_GetResult)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flexbe_msgs, action, BehaviorExecution_GetResult_Event)()->data;
  }
