...
ROSIDL_GENERATOR_C_EXPORT
bool flexbe_msgs__action__behavior_synthesis__send_goal__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.action._behavior_synthesis.BehaviorSynthesis_SendGoal_Event", full_classname_dest, 71) == 0);
  }
  flexbe_msgs__action__BehaviorSynthesis_SendGoal_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!flexbe_msgs__action__BehaviorSynthesis_SendGoal_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create flexbe_msgs__action__BehaviorSynthesis_SendGoal_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    flexbe_msgs__action__BehaviorSynthesis_SendGoal_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!flexbe_msgs__action__behavior_synthesis__send_goal__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!flexbe_msgs__action__BehaviorSynthesis_SendGoal_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create flexbe_msgs__action__BehaviorSynthesis_SendGoal_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    flexbe_msgs__action__BehaviorSynthesis_SendGoal_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!flexbe_msgs__action__behavior_synthesis__send_goal__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of BehaviorSynthesis_SendGoal_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.action._behavior_synthesis");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BehaviorSynthesis_SendGoal_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = flexbe_msgs__action__behavior_synthesis__send_goal__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = flexbe_msgs__action__behavior_synthesis__send_goal__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool flexbe_msgs__action__behavior_synthesis__get_result__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.action._behavior_synthesis.BehaviorSynthesis_GetResult_Event", full_classname_dest, 72) == 0);
  }
  flexbe_msgs__action__BehaviorSynthesis_GetResult_Event * ros_message = _ros_message;
  {  // info
    PyObject * field = PyObject_GetAttrString(_pymsg, "info");
    if (!field) {
      return false;
  ...
  {  // request
    ...
    if (!flexbe_msgs__action__BehaviorSynthesis_GetResult_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create flexbe_msgs__action__BehaviorSynthesis_GetResult_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    flexbe_msgs__action__BehaviorSynthesis_GetResult_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!flexbe_msgs__action__behavior_synthesis__get_result__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!flexbe_msgs__action__BehaviorSynthesis_GetResult_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create flexbe_msgs__action__BehaviorSynthesis_GetResult_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    flexbe_msgs__action__BehaviorSynthesis_GetResult_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!flexbe_msgs__action__behavior_synthesis__get_result__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of BehaviorSynthesis_GetResult_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.action._behavior_synthesis");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BehaviorSynthesis_GetResult_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->request.data[i]);
      PyObject * pyitem = flexbe_msgs__action__behavior_synthesis__get_result__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->response.data[i]);
      PyObject * pyitem = flexbe_msgs__action__behavior_synthesis__get_result__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
