...
bool flexbe_msgs__msg__behavior_log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.msg._behavior_log.BehaviorLog", full_classname_dest, 41) == 0);
  }
  flexbe_msgs__msg__BehaviorLog * ros_message = _ros_message;
  {  // text
...
{
  /* NOTE(esteve): Call constructor of BehaviorLog */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.msg._behavior_log");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BehaviorLog");
