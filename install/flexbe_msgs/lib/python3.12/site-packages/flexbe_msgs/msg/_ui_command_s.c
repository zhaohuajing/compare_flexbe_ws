...
bool flexbe_msgs__msg__ui_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.msg._ui_command.UICommand", full_classname_dest, 37) == 0);
  }
  flexbe_msgs__msg__UICommand * ros_message = _ros_message;
  {  // command
...
{
  /* NOTE(esteve): Call constructor of UICommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.msg._ui_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UICommand");
