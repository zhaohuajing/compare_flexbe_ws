...
bool flexbe_msgs__msg__be_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.msg._be_status.BEStatus", full_classname_dest, 35) == 0);
  }
  flexbe_msgs__msg__BEStatus * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of BEStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.msg._be_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BEStatus");
