...
bool flexbe_msgs__msg__synthesis_error_codes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.msg._synthesis_error_codes.SynthesisErrorCodes", full_classname_dest, 58) == 0);
  }
  flexbe_msgs__msg__SynthesisErrorCodes * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of SynthesisErrorCodes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.msg._synthesis_error_codes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SynthesisErrorCodes");
