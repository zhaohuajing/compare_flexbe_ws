...
gpd_ros__msg__CloudSamples__init(gpd_ros__msg__CloudSamples * msg)
{
  ...
  if (!gpd_ros__msg__CloudSources__init(&msg->cloud_sources)) {
    gpd_ros__msg__CloudSamples__fini(msg);
    return false;
  }
  // samples
...
gpd_ros__msg__CloudSamples__create(void)
{
  ...
  gpd_ros__msg__CloudSamples * msg = (gpd_ros__msg__CloudSamples *)allocator.allocate(sizeof(gpd_ros__msg__CloudSamples), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(gpd_ros__msg__CloudSamples));
  bool success = gpd_ros__msg__CloudSamples__init(msg);
  if (!success) {
...
gpd_ros__msg__CloudSamples__Sequence__init(gpd_ros__msg__CloudSamples__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gpd_ros__msg__CloudSamples * data = NULL;

  if (size) {
    data = (gpd_ros__msg__CloudSamples *)allocator.zero_allocate(size, sizeof(gpd_ros__msg__CloudSamples), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = gpd_ros__msg__CloudSamples__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        gpd_ros__msg__CloudSamples__fini(&data[i - 1]);
      }
...
gpd_ros__msg__CloudSamples__Sequence__fini(gpd_ros__msg__CloudSamples__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      gpd_ros__msg__CloudSamples__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gpd_ros__msg__CloudSamples__Sequence * array = (gpd_ros__msg__CloudSamples__Sequence *)allocator.allocate(sizeof(gpd_ros__msg__CloudSamples__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = gpd_ros__msg__CloudSamples__Sequence__init(array, size);
  if (!success) {
...
gpd_ros__msg__CloudSamples__Sequence__destroy(gpd_ros__msg__CloudSamples__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    gpd_ros__msg__CloudSamples__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
gpd_ros__msg__CloudSamples__Sequence__are_equal(const gpd_ros__msg__CloudSamples__Sequence * lhs, const gpd_ros__msg__CloudSamples__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!gpd_ros__msg__CloudSamples__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  gpd_ros__msg__CloudSamples__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(gpd_ros__msg__CloudSamples);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    gpd_ros__msg__CloudSamples * data =
      (gpd_ros__msg__CloudSamples *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gpd_ros__msg__CloudSamples__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gpd_ros__msg__CloudSamples__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!gpd_ros__msg__CloudSamples__copy(
