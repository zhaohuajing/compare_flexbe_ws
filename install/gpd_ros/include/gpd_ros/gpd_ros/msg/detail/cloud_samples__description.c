  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xf0, 0x16, 0x45, 0x52, 0x33, 0xd9, 0x91, 0x8b,
      0xe9, 0x90, 0xcd, 0x7a, 0xdf, 0x19, 0xb9, 0x7c,
      0xaf, 0x86, 0x72, 0xc1, 0x71, 0x0a, 0x45, 0xcb,
      0x13, 0xe4, 0x2a, 0x27, 0xc7, 0x43, 0x7c, 0x87,
    }};
  return &hash;
}
...
static char gpd_ros__msg__CloudSamples__TYPE_NAME[] = "gpd_ros/msg/CloudSamples";
...
static char gpd_ros__msg__CloudSamples__FIELD_NAME__cloud_sources[] = "cloud_sources";
static char gpd_ros__msg__CloudSamples__FIELD_NAME__samples[] = "samples";

static rosidl_runtime_c__type_description__Field gpd_ros__msg__CloudSamples__FIELDS[] = {
  {
    {gpd_ros__msg__CloudSamples__FIELD_NAME__cloud_sources, 13, 13},
    {
  ...
  {
    {gpd_ros__msg__CloudSamples__FIELD_NAME__samples, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription gpd_ros__msg__CloudSamples__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {gpd_ros__msg__CloudSamples__TYPE_NAME, 24, 24},
      {gpd_ros__msg__CloudSamples__FIELDS, 2, 2},
    },
    {gpd_ros__msg__CloudSamples__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[2].fields = gpd_ros__msg__CloudSources__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *gpd_ros__msg__CloudSamples__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[3] = *gpd_ros__msg__CloudSources__get_individual_type_description_source(NULL);
