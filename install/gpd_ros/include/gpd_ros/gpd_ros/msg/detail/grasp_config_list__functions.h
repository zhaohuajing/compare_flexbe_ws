...
#ifndef GPD_ROS__MSG__DETAIL__GRASP_CONFIG_LIST__FUNCTIONS_H_
#define GPD_ROS__MSG__DETAIL__GRASP_CONFIG_LIST__FUNCTIONS_H_
 ...
 * )) before or use
 * gpd_ros__msg__GraspConfigList__create()
 ...
 * calls
 * gpd_ros__msg__GraspConfigList__init().
...
/**
 * It calls
 * gpd_ros__msg__GraspConfigList__fini()
 ...
 * gpd_ros__msg__GraspConfigList__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * gpd_ros__msg__GraspConfigList__Sequence__fini()
 * on the array,
...
#endif  // GPD_ROS__MSG__DETAIL__GRASP_CONFIG_LIST__FUNCTIONS_H_
