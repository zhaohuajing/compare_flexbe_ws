...
: ${AMENT_CURRENT_PREFIX:="/home/csrobot/flexbe_ws/install/gpd_ros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gpd_ros/environment/pythonpath.sh"
