...
bool gpd_ros__msg__samples_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gpd_ros.msg._samples_msg.SamplesMsg", full_classname_dest, 35) == 0);
  }
  gpd_ros__msg__SamplesMsg * ros_message = _ros_message;
  {  // header
...
PyObject * gpd_ros__msg__samples_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gpd_ros.msg._samples_msg");
